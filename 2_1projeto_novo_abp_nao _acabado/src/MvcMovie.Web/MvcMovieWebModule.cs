...
[DependsOn(
    typeof(MvcMovieHttpApiClientModule),
...
public class MvcMovieWebModule : AbpModule
{
    ...
    private void ConfigureNavigationServices(IConfiguration configuration)
    {
        ...
        {
            options.MenuContributors.Add(new MvcMovieMenuContributor(configuration));
        });

        Configure<AbpToolbarOptions>(options =>
        {
            options.Contributors.Add(new MvcMovieToolbarContributor());
        });
    }
